...
namespace snu {
	...
	void BasicStat::htmlDS(FILE* fp) {
		...
		"
		, size, volume, num_vlabel, num_elabel
		, density, max_indegree, max_outdegree
		, max_vlabel_size, max_elabel_size, reciprocity
		, negativity);
	}
	void BasicStat::htmlUS(FILE* fp) {
		...
		"
		, size, volume, num_vlabel, num_elabel
		, density, avg_degree, max_degree
		, max_vlabel_size, max_elabel_size, negativity);
	}
}
